      ...
      <div>
          ...
          <div className='grid grid-cols-[720px_minmax(720px,_1fr)] pb-20'>
            ...
            <div>
                <div className='w-[606px] pt-[180px]'>
                    <h1 className='text-6xl font-semibold leading-[90px] font-nunito'>All The <span className='text-[#6379F4]'>Great</span> Kantongku Features.</h1>
                </div>
        ...
        <section>
          <footer className="footer pl-32 pt-16 pb-14 bg-[#6379F4] text-neutral-content">
              <div>
                <p className='text-2xl text-white font-semibold'>Kantongku</p>
